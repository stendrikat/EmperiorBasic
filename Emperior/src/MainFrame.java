...
public class MainFrame extends JFrame {
	...
	private void setEditorContentTypes() {
		...
		editorContentType.put("dart", "text/java");
		editorContentType.put("py", "text/python");
		editorContentType.put("boo", "text/java");
	}
	...
	protected static JComponent makeTextPanel(String filePath, String sourceCode) {
		...
		for(String s : DefaultSyntaxKit.getContentTypes()){
			System.out.println(s);
		}
		
		System.out.println(editorContentType.get(Main.getFileExtension(filePath)));
